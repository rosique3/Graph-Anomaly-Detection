...
print('\n--- Saving Graphs ---')
OUTPUT_PATH = 'data/graphs/graphml/'
os.makedirs(OUTPUT_PATH, exist_ok=True)

nx.write_graphml(G,  os.path.join(OUTPUT_PATH, "group_graph.graphml"))
nx.write_graphml(M,  os.path.join(OUTPUT_PATH, "member_graph.graphml"))
nx.write_graphml(MG, os.path.join(OUTPUT_PATH, "member_to_group_graph.graphml"))

print(f"--- Graphs Saved Successfully in {OUTPUT_PATH} ---")